...
class GasCar implements Vehicle {
  assemble(): void {
    console.log("Ensamblando un %cauto de combustión", COLORS.brown);
  }
  // Implementación del método assemble
...
class ElectricEngine implements Engine {
  start(): void {
    console.log("Arrancando %cmotor eléctrico", COLORS.green);
  }
...
class GasEngine implements Engine {
  start(): void {
    console.log("Arrancando %cmotor de combustión", COLORS.brown);
  }
  // Implementación del método start

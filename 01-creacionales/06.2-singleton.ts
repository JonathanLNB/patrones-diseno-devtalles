...
class DatabaseConnection {
  ...
  public connect(): void {
    if (this.connected) {
      console.log("Database is already connected", COLORS.red);
      return;
    }
    this.connected = true;
    console.log("Database connected", COLORS.green);
  ...
  public disconnect(): void {
    if (this.connected) {
      ...
      console.log("Database disconnected", COLORS.green);
      return;
    }
    console.log("Database is already disconnected", COLORS.red);
